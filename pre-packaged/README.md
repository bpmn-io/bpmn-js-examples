...
```html
<script src="https://unpkg.com/bpmn-js@8.1.0/dist/bpmn-viewer.development.js"></script>
```
...
<link rel="stylesheet" href="https://unpkg.com/bpmn-js@8.1.0/dist/assets/diagram-js.css" />
<link rel="stylesheet" href="https://unpkg.com/bpmn-js@8.1.0/dist/assets/bpmn-font/css/bpmn.css" />

<script src="https://unpkg.com/bpmn-js@8.1.0/dist/bpmn-modeler.development.js"></script>
```
