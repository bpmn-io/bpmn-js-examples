...
```html
<script src="https://unpkg.com/bpmn-js@8.8.3/dist/bpmn-viewer.development.js"></script>
```
...
<script src="https://unpkg.com/bpmn-js@8.8.3/dist/bpmn-modeler.development.js"></script>
```
