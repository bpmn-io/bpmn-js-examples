...
```html
<script src="https://unpkg.com/bpmn-js@6.0.4/dist/bpmn-viewer.development.js"></script>
```
...
<script src="https://unpkg.com/bpmn-js@6.0.4/dist/bpmn-modeler.development.js"></script>
```
