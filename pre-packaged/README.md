...
```html
<script src="https://unpkg.com/bpmn-js@6.1.1/dist/bpmn-viewer.development.js"></script>
```
...
<script src="https://unpkg.com/bpmn-js@6.1.1/dist/bpmn-modeler.development.js"></script>
```
