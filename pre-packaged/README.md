...
```html
<script src="https://unpkg.com/bpmn-js@1.3.0/dist/bpmn-viewer.development.js"></script>
```
...
<script src="https://unpkg.com/bpmn-js@1.3.0/dist/bpmn-modeler.development.js"></script>
```
