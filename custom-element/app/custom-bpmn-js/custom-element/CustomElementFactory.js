...
function CustomElementFactory(bpmnFactory, moddle, customModel) {
  ...
  this.create = function(elementType, attrs) {
    ...
    if (/^custom\:/.test(type)) {
      ...
      businessObject = customModel.getBusinessObject(type);
...
CustomElementFactory.$inject = [ 'bpmnFactory', 'moddle', 'customModel' ];
