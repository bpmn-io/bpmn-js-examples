/**
 * An example that showcases how to interact with a loaded
 * BPMN 2.0 diagram using bpmn-js
 */
(function() {
  ...
  var viewer = new BpmnJS({ container: document.querySelector('#js-canvas'), height: 400 });
